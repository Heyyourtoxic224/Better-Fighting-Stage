...
const creatures = {
    goblin: { name: "Goblin", defaultHP: 7, defaultAC: 13 },
    skeleton: { name: "Skeleton", defaultHP: 13, defaultAC: 13 },
    giantBoar: { name: "Giant Boar", defaultHP: 42, defaultAC: 12 },
    enemy: { name: "Enemy", defaultHP: 10, defaultAC: 10 }
};
